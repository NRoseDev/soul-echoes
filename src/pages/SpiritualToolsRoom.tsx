...
const sections = [
  ...
  { id: "angels-and-archangels", title: "Angels and Archangels", description: "All 15 archangels — who they are, what they carry, and how to invoke them in Source-rooted practice.", icon: Star, colorClass: "text-yellow-400" },
