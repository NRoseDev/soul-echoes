...
import {
  Diamond, Droplet, Hash, Leaf, Zap, Heart, Sparkles, Volume2, CheckSquare, Smile, Wind, Brain
} from "lucide-react";
...
const sections = [
  ...
  { id: "numerology-angel-numbers", title: "Numerology & Angel Numbers (33)", description: "Life Path numbers, soul urge, and the meaning behind all 33 repeating angel numbers.", icon: Hash, colorClass: "text-rose-300" },
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 pb-24" style={{ background: "radial-gradient(ellipse at 20% 20%, hsl(25,80%,5%) 0%, hsl(25,90%,14%) 45%, hsl(25,60%,26%) 100%)" }}>
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.4 }}>
        ...
        <p className="text-muted-foreground text-center mb-6">Practical tools and aids for healing. Learn the WHY in Wisdom, then apply it here. The AI can also send you directly to a tool when you need immediate help.</p>
      </motion.div>
